...
import { LockKeyhole, RefreshCcw } from 'lucide-preact';
...
const WiFiInput: FunctionalComponent<CustomInputProps> = ({ onInput }) => {
    ...
    const generateWiFiString = () => {
        ...
        let wifiString = `WIFI:T:${security};S:${escapeString(
            ssId
    ...
    return (
        <>
            <h3>WiFi QR-Code</h3>
            <p>
                Generate a QR-Code that will connect to a WiFi network with the
            ...
            <div className="radioList">
                ...
                <div className="inputBox checkbox">
                    ...
                    />
                    <label htmlFor={'encryption_wpa'}>
                        WPA / WPA2 (Modern networks)
                    </label>
                </div>
            </div>
            ...
            <div className="securityConcern">
                <LockKeyhole />
                <span>
                    Your data isn't sent to any server. It's only used to
